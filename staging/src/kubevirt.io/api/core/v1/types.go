...
const (
	...
	// VirtualMachinePodCPULimitsAnnotation indicates VMI pod CPU resource limits
	VirtualMachinePodCPULimitsAnnotation string = "kubevirt.io/vmi-pod-cpu-resource-limits"
)
