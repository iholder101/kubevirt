...
// because Go's encoding/xml namespace handling differs between the two packages.
// Callers must verify the Plugins feature gate is enabled before calling.
...
// libvirtxml Domain to the KubeVirt DomainSpec. This is needed because Go's
// encoding/xml handles namespace prefixes differently between the two packages.
// Note: libvirtxml also has QEMUCapabilities, QEMUOverride, and QEMUDeprecation
// fields which have no corresponding fields in KubeVirt's DomainSpec and are
// not transferred.
