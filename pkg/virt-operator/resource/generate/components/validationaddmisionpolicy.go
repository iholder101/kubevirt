...
const (
	...
	ErrModifySpec              = "this user cannot modify spec of node"
	ErrModifyStatus            = "this user cannot modify status of node"
	ErrAddDeleteLabels         = "this user cannot add/delete non kubevirt-owned labels"
	ErrUpdateLabels            = "this user cannot update non kubevirt-owned labels"
	ErrAddDeleteAnnotations    = "this user cannot add/delete non kubevirt-owned annotations"
	ErrUpdateAnnotations       = "this user cannot update non kubevirt-owned annotations"
	ErrChangeSubMetadataFields = "this user can only change allowed sub-metadata fields"
)
		...
		Spec: admissionregistrationv1.ValidatingAdmissionPolicySpec{
			...
			Validations: []admissionregistrationv1.Validation{
				...
				},
				{
					...
					Message:    ErrUpdateLabels,
				},
				{
					Expression: `size(variables.newNonKubevirtAnnotations) == size(variables.oldNonKubevirtAnnotations)`,
					Message:    ErrAddDeleteAnnotations,
				},
				{
					Expression: `variables.newNonKubevirtAnnotations.all(k, k in variables.oldNonKubevirtAnnotations && variables.newAnnotations[k] == variables.newAnnotations[k])`,
					Message:    ErrUpdateAnnotations,
				},
				{
					...
					Message:    ErrChangeSubMetadataFields,
				},
			},
		},
	}
