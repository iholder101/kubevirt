...
func generateValidationAdmissionPolicyBindingPatch(
...
//
//func (r *Reconciler) isValidationAdmissionPolicyBindingResourceAvailable() (bool, error) {
//	return r.isResourceAvailable(admissionregistrationv1.GroupName, "v1", "ValidatingAdmissionPolicyBinding")
//}
//
//func (r *Reconciler) isValidationAdmissionPolicyResourceAvailable() (bool, error) {
//	return r.isResourceAvailable(admissionregistrationv1.GroupName, "v1", "ValidatingAdmissionPolicy")
//}

func (r *Reconciler) createOrUpdateValidationAdmissionPolicyBindings() error {
	...
	for _, validatingAdmissionPolicyBinding := range r.targetStrategy.ValidatingAdmissionPolicyBindings() {
		err := r.createOrUpdateValidationAdmissionPolicyBinding(validatingAdmissionPolicyBinding.DeepCopy())
		if err != nil {
			return err
		}
	}
...
func (r *Reconciler) createOrUpdateValidationAdmissionPolicyBinding(validatingAdmissionPolicyBinding *admissionregistrationv1.ValidatingAdmissionPolicyBinding) error {
	...
	patchOps, err := generateValidationAdmissionPolicyBindingPatch(cachedValidatingAdmissionPolicyBinding, validatingAdmissionPolicyBinding)
	if err != nil {
...
func (r *Reconciler) createOrUpdateValidationAdmissionPolicies() error {
	...
	for _, validatingAdmissionPolicy := range r.targetStrategy.ValidatingAdmissionPolicies() {
		err := r.createOrUpdateValidationAdmissionPolicy(validatingAdmissionPolicy.DeepCopy())
		if err != nil {
			return err
		}
	}
...
func (r *Reconciler) createOrUpdateValidationAdmissionPolicy(validatingAdmissionPolicy *admissionregistrationv1.ValidatingAdmissionPolicy) error {
	admissionRegistrationV1 := r.clientset.AdmissionregistrationV1()
	version, imageRegistry, id := getTargetVersionRegistryID(r.kv)
